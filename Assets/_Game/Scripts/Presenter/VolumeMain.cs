...
namespace _Game.Scripts.Presenter
{
    public class VolumeMain : IDisposable
    {
        ...
        public VolumeMain(IVolume volume, IVolumeView volumeUI, ILevelProgression levelProgression,
            IClickHandler clickHandler, ResourcesManager resourcesManager)
        {
            _volume = volume;
            _volumeUI = volumeUI;
            ...
            _volumeUI.Init(resourcesManager.GetSpriteVolume(IconType.Off),
                resourcesManager.GetSpriteVolume(IconType.On),
                resourcesManager.GetAudioClipVolume(AudioType.Click),
                resourcesManager.GetAudioClipVolume(AudioType.Change),
            ...
            _volumeUI.ClickedButtonVolume += _volume.VolumeControl;
