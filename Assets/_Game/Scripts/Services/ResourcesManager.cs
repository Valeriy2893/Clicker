...
public class ResourcesManager
{
    ...
    public ResourcesManager()
    {
        ...
        _spritesVolume=configGame.IconVolumes.ToDictionary(iconVolume => iconVolume.Type,iconVolume => iconVolume.Icon);
        
        _audioVolume=configGame.AudioVolumes.ToDictionary(iconVolume => iconVolume.Type,iconVolume => iconVolume.Sound);
